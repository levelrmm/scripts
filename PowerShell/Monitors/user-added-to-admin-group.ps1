...
# -----------------------------------------------------------------------------
# Name: Windows Monitor - User Added to Admin Group
# Description: Check for events when users have been added to the local 
...
# -----------------------------------------------------------------------------
# Script: Windows Monitor - User Added to Admin Group
